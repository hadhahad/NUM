...
${OBJECTDIR}/SturmLiouville.o: SturmLiouville.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SturmLiouville.o SturmLiouville.cpp

${OBJECTDIR}/TridiagonalMatrix.o: TridiagonalMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TridiagonalMatrix.o TridiagonalMatrix.cpp
